...
class Base_Page(Borg, unittest.TestCase):
    ...
    def set_screenshot_dir(self, os_name, os_version,
    ...
    def get_screenshot_dir(self, os_name, os_version,
                           browser, browser_version, overwrite_flag=False):
    ...
    def set_text(self, locator, value, clear_flag=True):
        ...
        if text_field is not None:
            try:
                ...
                self.write(
                    'Could not write to text field: %s' %
                    locator, 'debug')
                self.write(str(e), 'debug')
                self.exceptions.append(
    ...
    def add_tesults_case(self, name, desc, suite, result_flag,
                         msg='', files=[], params={}, custom={}):
...
>>>>>>> master
    ...
    def write_test_summary(self):
        ...
        self.write(
            'Total number of mini-checks passed=%d' %
