...
def post_reports_to_slack():
    # To generate incoming webhook url ref:
    # https://qxf2.com/blog/post-pytest-test-results-on-slack/
    url = "incoming webhook url"  # Add your Slack incoming webhook url here

    # To generate pytest_report.log file add ">pytest_report.log" at end of
    # py.test command for e.g. py.test -k example_form -I Y -r F -v >
    ...
    slack_response = requests.post(
        url=url, data=json_params_encoded, headers={
