        ...
        if test_run_name is not None:
            ...
            if case_ids_list is not None:
                ...
                if description is not None:
                    if check_file_exists(os.path.join(
                            conf_dir, test_cases_conf)):
...
if __name__ == '__main__':
    # This script takes an optional command line argument for the TestRail run
    # id
