"""
Automated test for mobile application weather shopper payment page validations 
"""
import os, sys, time
...
def test_weather_shopper_app(test_mobile_obj):
    ...
    try:
        ...
        resul_flag = test_obj.verify_total(cart_total, least_expensive_item['price'])
        ...
        payment_details = {
            "image_path": "./screenshots/test_mobile_obj/*_enter_invalid_email.png",
        ...
        result_flag = test_obj.enter_invalid_email(payment_details)
        test_obj.log_result(result_flag,
            positive="Successfully completed payment",
            negative="Failure to complete payment")
        
        time.sleep(5)
        result_flag = test_obj.image_to_string(payment_details)
        test_obj.log_result(result_flag,
