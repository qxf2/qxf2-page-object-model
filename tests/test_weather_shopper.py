...
Our automated test will do the following:
    #Open Weather_shopper-main page.
    #Get text.
...
@pytest.mark.GUI
def test_weathershopper(test_obj):
    ...
    try:
        ...
        test_obj = PageFactory.get_page_object("weathershopper main page")
