...
def test_example_form(
    ...
    try:
        ...
        test_obj.add_tesults_case(
            "Set Phone Number",
            "Sets the phone number in the form",
            "test_example_form",
            result_flag,
            "Failed to set phone number: %s \nOn url: %s\n" %
            (phone,
             test_obj.get_current_url()),
            [],
            {},
            {
                '_Phone': phone,
                '_AnotherCustomField': 'Custom field value'})
        ...
        test_obj.add_tesults_case(
            "Set Gender",
            "Sets the gender in the form",
            "test_example_form",
            result_flag,
            "Failed to set gender: %s \nOn url: %s\n" %
            (gender,
             test_obj.get_current_url()),
            [])
        ...
        test_obj.add_tesults_case(
            "Check Heading",
            "Checks the heading on the redirect page",
            "test_example_form",
            result_flag,
            "Fail: Heading on the redirect page is incorrect!",
            [])

        # 12. Visit the contact page and verify the link
        result_flag = test_obj.goto_footer_link(
        ...
        test_obj.add_tesults_case(
            "Contact page",
            "Visits the contact page and verifies the link",
            "test_example_form",
            result_flag,
            "\nFailed to visit the Contact page\n")
