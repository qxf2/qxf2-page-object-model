...
firefox_versions = ["104","105"]  #firefox versions for the tests to run against on Browserstack/Sauce Labs
chrome_versions = ["104","105"]  #chrome versions for the tests to run against on Browserstack/Sauce Labs
...
default_config_list = [("chrome","105","windows","11")] #default configuration against which the test would run if no -B all option is used
