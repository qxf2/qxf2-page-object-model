...
src_conf_file5 = os.path.abspath(os.path.join(os.path.dirname(__file__),'opera_browser_conf.py'))
src_conf_file6 = os.path.abspath(os.path.join(os.path.dirname(__file__),'tesults_conf.py'))
#src_conf_file7 = os.path.abspath(os.path.join(os.path.dirname(__file__),'locators_boilerplate.py'))
src_conf_file7 = os.path.abspath(os.path.join(os.path.dirname(__file__),'..','templates','locators_boilerplate.py'))
...
#src_page_objects_file5 = os.path.abspath(os.path.join(os.path.dirname(__file__),'..','page_objects','main_page_boilerplate.py'))
#src_page_objects_file6 = os.path.abspath(os.path.join(os.path.dirname(__file__),'..','page_objects','page_object_boilerplate.py'))
#src_page_objects_file7 = os.path.abspath(os.path.join(os.path.dirname(__file__),'..','page_objects','PageFactory_boilerplate.py'))
src_page_objects_file5 = os.path.abspath(os.path.join(os.path.dirname(__file__),'..','templates','main_page_boilerplate.py'))
src_page_objects_file6 = os.path.abspath(os.path.join(os.path.dirname(__file__),'..','templates','page_object_boilerplate.py'))
src_page_objects_file7 = os.path.abspath(os.path.join(os.path.dirname(__file__),'..','templates','PageFactory_boilerplate.py'))
...
src_tests_file1 = os.path.abspath(os.path.join(os.path.dirname(__file__),'..','templates','test_boilerplate.py'))

#src tests file list:
src_tests_files_list = [src_tests_file1]
