...
# Files from src:
src_file1 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        '__init__.py'))
src_file2 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        'conftest.py'))
src_file3 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        'Readme.md'))
src_file4 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        'Requirements.txt'))
src_file5 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        'setup.cfg'))
...
# CONF
# files from src conf:
src_conf_file1 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        'testrailenv_conf.py'))
src_conf_file2 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        'remote_credentials.py'))
src_conf_file3 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        'browser_os_name_conf.py'))
src_conf_file4 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '__init__.py'))
...
dst_folder_conf = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        '..',
...
src_page_objects_file1 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        'page_objects',
        'Base_Page.py'))
src_page_objects_file2 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        'page_objects',
        'DriverFactory.py'))
src_page_objects_file3 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        'page_objects',
        'PageFactory.py'))
src_page_objects_file4 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        'page_objects',
...
src_page_objects_files_list = [
    src_page_objects_file1,
    src_page_objects_file2,
    src_page_objects_file3,
    src_page_objects_file4]

# destination folder for page_objects:
dst_folder_page_objects = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        '..',
...
src_folder_utils = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        'utils'))
dst_folder_utils = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        '..',
...
src_utils_file1 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        'utils',
        'Base_Logging.py'))
src_utils_file2 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        'utils',
        'BrowserStack_Library.py'))
src_utils_file3 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        'utils',
        'Option_Parser.py'))
src_utils_file4 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        'utils',
        'setup_testrail.py'))
src_utils_file5 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        'utils',
        'Test_Rail.py'))
src_utils_file6 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        'utils',
        'Test_Runner_Class.py'))
src_utils_file7 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        'utils',
        'testrail.py'))
src_utils_file8 = os.path.abspath(
    os.path.join(
        os.path.dirname(__file__),
        '..',
        'utils',
