...
class BrowserStackRunner(RemoteOptions):
    ...
    def browserstack_capabilities(self, desired_capabilities, app_name, app_path, appium_version):
        ...
        desired_capabilities['app'] = self.browserstack_upload(app_name, app_path) #upload the application to the Browserstack Storage
    ...
    def browserstack_upload(self, app_name, app_path):
        ...
        try:
            ...
            post_response = requests.post(self.browserstack_app_upload_url,
                                          files=files, auth=(self.username, self.password))
    ...
    def get_browserstack_mobile_driver(self, app_path, app_name, desired_capabilities,
        ...
        desired_capabilities = self.browserstack_capabilities(desired_capabilities, app_name, app_path, appium_version)
        mobile_driver = self.set_capabilities_options(desired_capabilities, url=self.browserstack_url)
